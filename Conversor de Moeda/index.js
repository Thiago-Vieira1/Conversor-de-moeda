...
// Se o usuário não digitar nada, assume 'dolar' como moeda base e 'real' como moeda final
...
(async () => {
    ...
    console.log(`A valor de 1 ${moedaBase} em ${moedaFinal} é ${result}`);
    await browser.close();
  })();